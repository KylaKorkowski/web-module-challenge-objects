...
console.log(createMenuItem('grilled cheese', 5, 'lunch'));
console.log(createMenuItem('quesadilla', 6, 'lunch'));
...
function getLastReview(array) {
  ...
  return `${array[item].name} gave the restaurant a ${array[array.length -1].rating} star review, and their feedback was: ${array[array.length -1].feedback}`;
} 
